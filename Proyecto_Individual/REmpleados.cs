...
namespace Proyecto_Individual {
    ...
    public class REmpleados : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Proyecto_Individual.REmpleados.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedREmpleados : Component, ICachedReport {
        
        public CachedREmpleados() {
        }
